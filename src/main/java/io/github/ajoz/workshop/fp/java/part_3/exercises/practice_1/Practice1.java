package io.github.ajoz.workshop.fp.java.part_3.exercises.practice_1;
...
abstract class Try<A> {
    ...
    public static <A> Try<A> success(final A value) {
        throw new UnsupportedOperationException("Practice1 Try.success is missing!");
    }

    public static <A> Try<A> failure(final Throwable error) {
        throw new UnsupportedOperationException("Practice1 Try.failure is missing!");
    }
...
class HardwareInfo {
    ...
    Try<Architecture> getArchitecture() {
        ...
        return Try.failure(new RuntimeException("Architecture is not specified!"));
    }
}
...
public class Practice1 {
    public static void tryLogging(final DeviceAPI api) {
        throw new UnsupportedOperationException("Practice1 tryLogging is missing!");
    }
