...
public class Exercise6Test {
    ...
    public void should_compose_function_with_consumer() {
        ...
        // when:
        final Consumer1<String> tested = Exercise6.composeConsumer(function, consumer);
    ...
    public void should_compose_function_with_supplier() {
        ...
        // when:
        final Supplier<Integer> tested = Exercise6.composeSupplier(supplier, function);
    ...
    public void should_apply_first_argument() {
        ...
        // when:
        final Function1<Integer, String> tested = Exercise6.applyFirst(function, supplier);
