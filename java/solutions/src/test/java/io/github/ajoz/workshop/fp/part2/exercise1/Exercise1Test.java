...
public class Exercise1Test {
    ...
    public static class InTermsOfFoo {
        ...
        public void sumAndSumInTermsOfFooShouldBeEqual() {
            ...
            // when:
            final Integer expected = Exercise1.sum(list);
            final Integer actual = Exercise1.fooSum(list);
        ...
        public void productAndProductInTermsOfFooShouldBeEqual() {
            ...
            // when:
            final Integer expected = Exercise1.product(list);
            final Integer actual = Exercise1.fooProduct(list);
