...
public class Exercise4Test {
    ...
    public void shouldNotContainAValueOnAnEmptyList() {
        ...
        // when:
        final Boolean actual = Exercise4.contains(emptyList, 1);
        // then:
    ...
    public void shouldNotContainAValue() {
        ...
        final Boolean expected = false;
        // when:
        final Boolean actual = Exercise4.contains(list, 1);
        // then:
        assertThat(actual, is(expected));
    }
    ...
    public void shouldContainAValue() {
        ...
        // when:
        final Boolean actual = Exercise4.contains(stringList, "test");
        // then:
        assertThat(actual, is(expected));
    }
    ...
    public void shouldCalculateAverage() {
        ...
        // when:
        final Integer actual = Exercise4.average(list);
        // then:
        assertThat(actual, is(expected));
    }
    ...
    public void shouldFindLastElement() {
        ...
        // when:
        final Integer actual = Exercise4.last(list);
        // then:
        assertThat(actual, is(expected));
    }
    ...
    public void shouldJoinAList() {
        ...
        // when:
        final String actual = Exercise4.join(list, ":");
        // then:
        assertThat(actual, is(expected));
    }
    ...
    public void shouldJoinOneElementList() {
        ...
        // when:
        final String actual = Exercise4.join(list, "_");
        // then:
        assertThat(actual, is(expected));
    }
    ...
    public void shouldCountListElements() {
        ...
        // when:
        final Integer actual = Exercise4.count(list);
        // then:
        assertThat(actual, is(expected));
    }
    ...
    public void shouldReverseAnEmptyList() {
        ...
        final List<String> list = emptyList();
        // when:
        final List<String> actual = Exercise4.reverse(list);
        // then:
    ...
    public void shouldReverseAList() {
        ...
        // when:
        final List<Integer> actual = Exercise4.reverse(list);
        // then:
        assertThat(actual, is(expected));
    }
    ...
    public void shouldFindMaximum() {
        ...
        // when:
        final Integer actual = Exercise4.maximum(list);
    ...
    public void shouldFindMinimum() {
        ...
        // when:
        final Integer actual = Exercise4.minimum(list);
    ...
    public void shouldFindPenultimateElement() {
        ...
        // when:
        final Integer actual = Exercise4.penultimate(list);
