...
public class Exercise3Test {
    ...
    public void sum_with_foldRight_should_be_equal_to_sum_with_foldLeft() {
        ...
        // when:
        final Integer sumLeft = Exercise3.foldLeft(list, 0, (a, b) -> a + b);
        final Integer sumRight = Exercise3.foldRight(list, 0, (a, b) -> a + b);
    ...
    public void foldRight_structure_should_be_correct() {
        ...
        // when:
        final String actual = Exercise3.foldRight(list, "0",
    ...
    public void foldRight_in_terms_of_foldLeft() {
        ...
        // when:
        final String actual = Exercise3.foldRight2(list, "0",
                (integer, string) -> String.format("(%d + %s)", integer, string)
        );
