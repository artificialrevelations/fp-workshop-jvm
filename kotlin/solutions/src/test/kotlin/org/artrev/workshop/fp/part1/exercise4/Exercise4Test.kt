...
class Exercise4Test {
    ...
    class Curry {
        ...
        @Test
        fun `should use an extension function for currying`() {
            // given:
            val add: (Int, Int) -> Int = { a, b -> a + b }

            // when:
            val tested = add.curried()
    ...
    class Flip {
        ...
        @Test
        fun `should use an extension function to flip a curried function`() {
            // given:
            val function: (String) -> (Int) -> String = { string ->
                { integer ->
                    String.format("%s : %d", string, integer)
        ...
        @Test
        fun `should use an extension function to flip a two arg function`() {
            // given:
            // given:
            val function: (String, Int) -> String = { string, integer ->
                String.format("%s : %d", string, integer)
